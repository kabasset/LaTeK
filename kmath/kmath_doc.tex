...
\rmq{As opposed to unstarred versions of \cref{ssec-delim-def}, these commands are available in text mode.}
...
\rmq[Warning -- ]{No space should be added between the 3rd, 4th and 5th argument, that is,
\verb|\kfuncdef{f}{E}{F} [x] [y]|
will produce $\kfuncdef{f}{E}{F} [x] [y]$.}
